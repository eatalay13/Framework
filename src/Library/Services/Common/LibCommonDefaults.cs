...
namespace Services.Common
{
    ...
    /// </summary>
    public static partial class LibCommonDefaults
    {
        /// <summary>
        ...
        /// {0} : address attribute ID
        /// </remarks>
        public static CacheKey AddressAttributeValuesByAttributeCacheKey => new CacheKey("Lib.addressattributevalue.byattribute.{0}");
        ...
        /// {1} : key group
        /// </remarks>
        public static CacheKey GenericAttributeCacheKey => new CacheKey("Lib.genericattribute.{0}-{1}");
