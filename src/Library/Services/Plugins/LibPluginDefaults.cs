...
namespace Services.Plugins
{
    ...
    /// </summary>
    public static partial class LibPluginDefaults
    {
        /// <summary>
        ...
        /// </remarks>
        public static CacheKey AdminNavigationPluginsCacheKey => new CacheKey("Lib.plugins.adminnavigation.{0}", AdminNavigationPluginsPrefix);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string AdminNavigationPluginsPrefix => "Lib.plugins.adminnavigation.";
    }
}