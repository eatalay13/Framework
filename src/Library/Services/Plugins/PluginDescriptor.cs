...
namespace Services.Plugins
{
    ...
    public partial class PluginDescriptor : PluginDescriptorBaseInfo, IDescriptor, IComparable<PluginDescriptor>
    {
        ...
        {
            var fileProvider = EngineContext.Current.Resolve<ILibFileProvider>();
            ...
            var filePath = fileProvider.Combine(fileProvider.GetDirectoryName(OriginalAssemblyFile), LibPluginDefaults.DescriptionFileName);
