...
namespace Services.Themes
{
    ...
    public partial class ThemeProvider : IThemeProvider
    {
        ...
        public ThemeProvider(ILibFileProvider fileProvider)
        {
        ...
        protected virtual void Initialize()
        {
            ...
            lock (_locker)
            {
                ...
                var themeDirectoryPath = _fileProvider.MapPath(LibPluginDefaults.ThemesPath);
                foreach (var descriptionFile in _fileProvider.GetFiles(themeDirectoryPath,
                    LibPluginDefaults.ThemeDescriptionFileName, false))
                {
